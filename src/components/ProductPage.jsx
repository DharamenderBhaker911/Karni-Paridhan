...
function StickyBuyBar({ price, originalPrice, onAdd, onBuy, productName, selectedSize }) {
  const disc = 75;
  return (
...
export default function ProductPage({ product: rawProduct, allProducts, onClose, onAdd, onBuyNow }) {
  ...
  return (
    <div className="pdp-shell">
      ...
      <StickyBuyBar price={rawProduct.price} originalPrice={rawProduct.originalPrice} onAdd={handleAdd} onBuy={handleBuy} productName={rawProduct.name} selectedSize={selectedSize} />
