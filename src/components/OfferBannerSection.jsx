...
const SLIDES = [
  {
    ...
    badge: "75%",
    badgeLabel: "OFF",
    // Saffron Sunrise — warm Indian ethnic feel
    accent: "linear-gradient(145deg, #5c1a0f 0%, #8b2e14 30%, #c04e20 65%, #e07840 100%)",
    orbColor1: "rgba(240,160,80,0.28)",
    orbColor2: "rgba(220,120,60,0.20)",
  ...
  },
  {
    ...
    badge: "B2G1",
    badgeLabel: "FREE",
    // Rose Petal Bloom — soft blush with deep wine undertone
    accent: "linear-gradient(145deg, #4a1028 0%, #7a2042 30%, #b05070 60%, #d48090 100%)",
    orbColor1: "rgba(200,130,130,0.30)",
    orbColor2: "rgba(220,170,120,0.22)",
  ...
  },
  {
    ...
    badge: "10%",
    badgeLabel: "EXTRA",
    // Marigold Harvest — deep amber with warm ochre
    accent: "linear-gradient(145deg, #3d2000 0%, #6b3800 30%, #a05c00 60%, #c88020 100%)",
    orbColor1: "rgba(210,150,40,0.28)",
    orbColor2: "rgba(230,180,80,0.20)",
