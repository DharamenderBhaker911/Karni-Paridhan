...
const IconTruck = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="1" y="3" width="15" height="13"/><path d="M16 8h4l3 5v3h-7V8zM5.5 21a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM18.5 21a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/></svg>
);
const IconReturn = () => (
...
const trustBadges = [
  { icon: <IconTruck />, title: "Free Shipping", sub: "On orders ₹999+" },
  { icon: <IconReturn />, title: "Easy Returns", sub: "7-day hassle-free" },
  { icon: <IconLock />, title: "Secure Payments", sub: "100% encrypted" },
];
          ...
          <div className="footer-contact-col-v2">
            ...
            <ul className="footer-contact-list">
              ...
              <li>
                ...
                <a href="tel:+919784842239">+91 9784842239</a>
              </li>
              <li>
